...
describe("CategoriesScreen", () => {
	...
	it("wires controller actions into category state updates", async () => {
		const { createCategoriesState } = await loadScreen();
		const { renderCategoriesView } = await import("./categoriesViewController");
